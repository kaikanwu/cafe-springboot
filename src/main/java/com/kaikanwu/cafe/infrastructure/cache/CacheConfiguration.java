package com.kaikanwu.cafe.infrastructure.cache;
...
public class CacheConfiguration {
    ...
    public Cache getSettlementTTLCache() {
        return new CaffeineCache("settlement",
                Caffeine.newBuilder().expireAfterAccess(10 * DEFAULT_CACHE_EXPIRES, TimeUnit.MILLISECONDS).build());
    }
